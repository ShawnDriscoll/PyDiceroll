...
**PyDiceroll 3.2 Overview**
===========================

**PyDiceroll 3.2** is easy-to-use open source die rolling software. Written
in Python 3.9.4 and using a variety of IDEs, **PyDiceroll 3.2** supports
many gaming and RPG die rolling conventions.

**PyDiceroll 3.2** also supports logging, error reporting, and debugging
of rolls made.
