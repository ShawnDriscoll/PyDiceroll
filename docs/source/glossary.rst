...
.. glossary::
   ...
   import
     ...
     of the most over-used commands in Python.
   ...
   pip
     ...
     the way most people install Python modules uploaded by other people.

   print()
     Always remember to use **(** and **)** when using a print function.
	 
   PyDiceroll
     A Python module available from this `GitHub <https://github.com/ShawnDriscoll/pydiceroll/>`__ repository.
