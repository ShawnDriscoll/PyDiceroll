...
**PyDiceroll 3.5** keeps a log file of any dice rolls made during its last run. You will find ``PyDiceroll.log`` in the ``Logs``
...
Your **INFO** logging will output as:
   ...
   | ...INFO PyDiceroll - roll() v3.5 started, and running...
